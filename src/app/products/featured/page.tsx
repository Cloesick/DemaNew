...
export default function FeaturedProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#00ADEF] via-blue-500 to-indigo-600 text-white">
      ...
      <div className="bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl font-bold text-[#00ADEF]">{featuredProducts.length}</div>
              <div className="text-gray-600">Featured Products</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#00ADEF]">{categories.length - 1}</div>
              <div className="text-gray-600">Catalogs</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#00ADEF]">100%</div>
              <div className="text-gray-600">Verified Quality</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#00ADEF]">New</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {filteredProducts.map((product) => (
              ...
              >
                ...
                {/* Product Info */}
                <div className="p-6">
                  <div className="text-sm text-[#00ADEF] font-semibold mb-2">
                    SKU: {product.sku}
                  </div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-[#00ADEF] transition">
                    {product.name}
                  </h3>
                  {product.series_name && (
                ...
                {/* Hover Effect */}
                <div className="absolute inset-0 border-4 border-transparent group-hover:border-[#00ADEF] rounded-xl transition-colors pointer-events-none"></div>
              </Link>
            ))}
          </div>
        )}
      ...
      {/* Call to Action */}
      <div className="bg-gradient-to-r from-[#00ADEF] to-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Explore Our Complete Catalog</h2>
          <p className="text-xl opacity-90 mb-8">
            Discover thousands more products across all our industrial catalogs
          </p>
          <Link
            href="/catalog"
            className="inline-block bg-white text-[#00ADEF] px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition shadow-xl"
          >
            Browse Full Catalog →
          </Link>
        </div>
