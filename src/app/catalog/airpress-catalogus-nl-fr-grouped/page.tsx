...
export default function AirpressCatalogusNlFrCatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/airpress_catalogus_nl_fr_products.json')
      .then(data => {
        console.log('Loaded Airpress Catalog (NL/FR):', data.length, 'groups');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#F97316] to-[#EA580C] text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl font-bold mb-4">🎨 Airpress Catalog (NL/FR)</h1>
