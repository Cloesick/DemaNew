...
export default function AirpressCatalogusEngCatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/airpress_catalogus_eng_products.json')
      .then(data => {
        console.log('Loaded Airpress Catalog (English):', data.length, 'groups');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#F97316] to-[#EA580C] text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl font-bold mb-4">🎨 Airpress Catalog (English)</h1>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-[#F97316]">{filteredGroups.length}</div>
              <div className="text-gray-600">Image Groups</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#F97316]">{totalProducts}</div>
