...
export default function CatalogHighlightsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#00ADEF] via-blue-600 to-indigo-700 text-white">
              ...
              <button
                ...
                className={`px-6 py-3 rounded-full whitespace-nowrap font-semibold transition-all ${
                  selectedCategory === category.id
                    ? 'bg-gradient-to-r from-[#00ADEF] to-blue-600 text-white shadow-xl scale-105'
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[#00ADEF] font-semibold group-hover:translate-x-2 transition-transform">
                        View Catalog →
                      </span>
                    </div>
                  </div>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex gap-2">
                    <button className="flex-1 bg-[#00ADEF] text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-600 transition text-sm">
                      View Products
                    </button>
                    <a
                      ...
                      className="px-4 py-2 border-2 border-[#00ADEF] text-[#00ADEF] rounded-lg hover:bg-[#00ADEF] hover:text-white transition"
                    >
      ...
      {/* Call to Action */}
      <div className="bg-gradient-to-r from-[#00ADEF] to-indigo-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-4">
            <Link
              href="/contact"
              className="bg-white text-[#00ADEF] px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition shadow-xl"
            >
              Contact Us
            </Link>
            <Link
