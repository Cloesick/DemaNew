...
export default function CatalogExplorerPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-4 border-[#00ADEF] border-t-transparent mx-auto mb-4"></div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#00ADEF] via-blue-600 to-purple-600 text-white">
      ...
      <div className="bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-3xl font-bold text-[#00ADEF]">{products.length.toLocaleString()}</div>
              <div className="text-gray-600 text-sm">Total Products</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#00ADEF]">{filteredProducts.length.toLocaleString()}</div>
              <div className="text-gray-600 text-sm">Filtered Results</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#00ADEF]">{catalogs.length}</div>
              <div className="text-gray-600 text-sm">Catalogs</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#00ADEF]">{totalPages}</div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00ADEF] focus:border-transparent"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00ADEF] focus:border-transparent bg-white"
            >
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20">
            ...
            <button
              ...
              className="bg-[#00ADEF] text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-600 transition"
            >
              Reset Filters
            </button>
          </div>
            ...
            <div className="mb-6 flex justify-between items-center">
              ...
              {searchQuery && (
                <button
                  ...
                  className="text-[#00ADEF] hover:text-blue-600 font-semibold"
                >
                  Clear search
                </button>
              )}
              ...
              {currentProducts.map((product) => (
                ...
                >
                  ...
                  <div className="p-4 flex-1">
                    <div className="text-xs text-[#00ADEF] font-semibold mb-1">
                      SKU: {product.sku}
                    </div>
                    <h3 className="font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-[#00ADEF] transition">
                      {product.name}
                    </h3>
            ...
            {totalPages > 1 && (
              <div className="mt-12 flex justify-center items-center gap-2">
                <button
                  ...
                  className="px-6 py-3 border-2 border-gray-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:border-[#00ADEF] hover:text-[#00ADEF] font-semibold transition"
                >
                  ← Previous
                </button>
                      ...
                      <button
                        ...
                        className={`w-12 h-12 rounded-lg font-semibold transition ${
                          currentPage === pageNum
                            ...
                            : 'bg-white border-2 border-gray-300 hover:border-[#00ADEF] hover:text-[#00ADEF]'
                        }`}
                      >
                        {pageNum}
                      </button>
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-[#00ADEF] to-purple-600 text-white py-12 mt-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <Link
              ...
              className="bg-white text-[#00ADEF] px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition shadow-xl"
            >
              ⭐ Featured Products
            </Link>
            <Link
