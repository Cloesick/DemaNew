...
export default function KranzleCatalogus2021Nl1CatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/kranzle_catalogus_2021_nl_1_grouped.json')
      .then(data => {
  ...
  const flatProducts = productGroups.flatMap(group =>
    group.variants.map((v: any) => ({
      ...
      pdf_source: 'kranzle_catalogus_2021_nl_1.pdf',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#00ADEF] to-blue-500 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">📦 Kranzle_Catalogus_2021_Nl_1 - Product Groups</h1>
