...
export default function ZuigerpompenCatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/zuigerpompen_products.json')
      .then(data => {
        console.log('Loaded Zuigerpompen:', data.length, 'groups');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#00ADEF] to-[#0066CC] text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl font-bold mb-4">🎨 Zuigerpompen</h1>
