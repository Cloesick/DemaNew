...
export default function MakitaCatalogus2022NlCatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/makita_catalogus_2022_nl_products.json')
      .then(data => {
        console.log('Loaded Makita Catalog 2022:', data.length, 'groups');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#14B8A6] to-[#0D9488] text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl font-bold mb-4">🎨 Makita Catalog 2022</h1>
