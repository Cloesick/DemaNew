...
export default function AandrijftechniekCatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/aandrijftechniek_image_mapping.json')
      .then(data => {
