...
export default function KunststofAfvoerleidingenCatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/kunststof_afvoerleidingen_grouped.json')
      .then(data => {
  ...
  const flatProducts = productGroups.flatMap(group =>
    group.variants.map((v: any) => ({
      ...
      pdf_source: 'kunststof_afvoerleidingen.pdf',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#00ADEF] to-blue-500 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">📦 Kunststof_Afvoerleidingen - Product Groups</h1>
