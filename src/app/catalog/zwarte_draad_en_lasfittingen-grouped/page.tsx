...
export default function ZwarteDraadEnLasfittingenCatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/zwarte_draad_en_lasfittingen_grouped.json')
      .then(data => {
  ...
  const flatProducts = productGroups.flatMap(group =>
    group.variants.map((v: any) => ({
      ...
      pdf_source: 'zwarte_draad_en_lasfittingen.pdf',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#00ADEF] to-blue-500 text-white">
        <div className="container mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold mb-4">📦 Zwarte_Draad_En_Lasfittingen - Product Groups</h1>
