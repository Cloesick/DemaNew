...
export default function MakitaTuinfolder2022NlCatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/makita_tuinfolder_2022_nl_products.json')
      .then(data => {
        console.log('Loaded Makita Tuinfolder 2022:', data.length, 'groups');
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-4 border-[#14B8A6] border-t-transparent"></div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#14B8A6] to-[#0D9488] text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl font-bold mb-4">🎨 Makita Tuinfolder 2022</h1>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-[#14B8A6]">{filteredGroups.length}</div>
              <div className="text-gray-600">Image Groups</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#14B8A6]">{totalProducts}</div>
