...
export default function KranzleCatalogus2021Nl1CatalogPage() {
  ...
  useEffect(() => {
    fetchJsonSafe('/data/kranzle_catalogus_2021_nl_1_products.json')
      .then(data => {
        console.log('Loaded Kränzle Catalog 2021:', data.length, 'groups');
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-4 border-[#EF4444] border-t-transparent"></div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#EF4444] to-[#DC2626] text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <h1 className="text-4xl font-bold mb-4">🎨 Kränzle Catalog 2021</h1>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-[#EF4444]">{filteredGroups.length}</div>
              <div className="text-gray-600">Image Groups</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#EF4444]">{totalProducts}</div>
          ...
          <div className="flex gap-4 items-center">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#EF4444] focus:border-transparent"
              />
            </div>
              ...
              <button
                ...
                className={`p-3 rounded-lg border-2 transition ${
                  viewMode === 'grid'
                    ...
                    : 'border-gray-300 hover:border-[#EF4444]'
                }`}
              >
