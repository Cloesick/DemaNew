...
export default function Home() {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="relative text-white overflow-hidden" style={{ background: 'linear-gradient(to right, #00ADEF, #0088CC)' }}>
        <div className="absolute inset-0">
          <div className="absolute inset-0 opacity-90" style={{ background: 'linear-gradient(to right, #00ADEF, #0088CC)' }}></div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
                9,757 products from 26 industrial catalogs with high-quality images
              </p>
            </div>

            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {catalogProducts.map((product) => (
                <CatalogProductCard key={product.sku} product={product} viewMode="grid" />
              ))}
            </div>
            ...
            <div className="mt-12 text-center">
              <Link
                href="/catalog"
                className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white transition"
              ...
              >
                Browse Full Catalog (9,757 Products)
