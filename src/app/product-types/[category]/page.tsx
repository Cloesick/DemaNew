...
export default function CategoryPage({ params }: { params: Promise<{ category: string }> }) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/product-types" className="text-[#00ADEF] hover:underline">
            ← Back to Categories
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Header */}
      <div className="bg-gradient-to-r from-[#00ADEF] to-blue-600 text-white py-12">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00ADEF] focus:border-transparent"
              />
            </div>
