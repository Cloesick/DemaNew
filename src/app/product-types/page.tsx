        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((category) => (
            <Link
              ...
              className="group bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-[#00ADEF]"
            >
              {/* Header */}
              <div className="bg-gradient-to-br from-blue-50 to-gray-50 p-6 border-b border-gray-200 group-hover:from-blue-100 group-hover:to-blue-50 transition-colors">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="bg-[#00ADEF] text-white px-3 py-1 rounded-full text-xs font-bold">
                    {category.groups} groups
                  </div>
                </div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2 group-hover:text-[#00ADEF] transition-colors">
                  {category.name}
                </h2>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <span className="text-sm font-semibold text-gray-700 group-hover:text-[#00ADEF] transition-colors">
                    Browse Products
                  </span>
                  <ArrowRight className="w-5 h-5 text-[#00ADEF] group-hover:translate-x-1 transition-transform" />
                </div>
              </div>
            </Link>
          ))}
