      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center group hover:scale-105 transition-transform duration-300">
            <div className="text-3xl font-bold text-[#00ADEF] group-hover:text-[#0088C0] transition-colors">
              {stats.catalogs}
            </div>
...
export const StatsBannerExtended: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#00ADEF] to-[#0088C0] text-white border-b shadow-lg">
